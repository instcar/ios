...
//    [placeHolderLayer setFrame:self.bounds];
//    [placeHolderLayer setContents:(id)placeholder.CGImage];
////    [placeHolderLayer setBackgroundColor:[UIColor whiteColor].CGColor];
...
//                    [[[self.layer sublayers]objectAtIndex:0] addAnimation:opacityAnim forKey:nil];
