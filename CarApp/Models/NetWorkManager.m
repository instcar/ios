...
+(ASIFormDataRequest *)networkEditHeadpic:(UIImage *)photo uid:(long)uid mode:(kNetworkrequestMode)mode success:(void (^)(BOOL, NSString *, NSString *))success failure:(void (^)(NSError *))failure
{
    ...
    photo = [photo imageByScalingAndCroppingForSize:CGSizeMake(100, 100)];
...
+(void)networkGetUserInfoWithuid:(long)uid success:(void (^)(BOOL, NSDictionary *, NSString *))success failure:(void (^)(NSError *))failure
{
    ...
    [request setCompletionBlock:^{
        ...
        NSString *msg = @"";
        if (flag) {
            userInfo = [dic objectForKey:@"user"];
        }
        else
        {
            msg = [dic valueForKey:@"msg"];
...
{
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%@yx/api/user/infocenter", kServerHost]];
    
    NSString  *keyValueString = [NSString stringWithFormat:@"appkey=%@&uid=%ld",APPKEY,uid];
    NSString  *sign = [NSString stringWithFormat:@"%@",[NetWorkUtility generateSign:keyValueString]];
    
    __block ASIFormDataRequest *request = [ASIFormDataRequest requestWithURL:url usingCache:[ASIDownloadCache sharedCache] andCachePolicy:ASIAskServerIfModifiedCachePolicy|ASIAskServerIfModifiedWhenStaleCachePolicy|ASIFallbackToCacheIfLoadFailsCachePolicy];
    [request addPostValue:APPKEY forKey:@"appkey"];
    [request addPostValue:[NSNumber numberWithLong:uid] forKey:@"uid"];
    [request addPostValue:sign forKey:@"sign"];
...
{
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%@yx/judian/api/nearestlist", kServerHost]];
    ...
    [request addPostValue:[NSNumber numberWithInt:rows] forKey:@"rows"];
    [request addPostValue:[NSNumber numberWithInt:page] forKey:@"page"];
    [request addPostValue:[NSNumber numberWithDouble:lng] forKey:@"lng"];
    [request addPostValue:[NSNumber numberWithDouble:lat] forKey:@"lat"];
    [request addPostValue:sign forKey:@"sign"];
...
{
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%@yx/line/listbyjudian", kServerHost]];
    ...
    [request addPostValue:[NSNumber numberWithInt:rows] forKey:@"rows"];
    [request addPostValue:[NSNumber numberWithInt:page] forKey:@"page"];
    [request addPostValue:[NSNumber numberWithLong:judianID] forKey:@"judianid"];
    [request addPostValue:sign forKey:@"sign"];
...
{
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%@yx/line/listbytag", kServerHost]];
    ...
    [request addPostValue:[NSNumber numberWithInt:rows] forKey:@"rows"];
    [request addPostValue:[NSNumber numberWithInt:page] forKey:@"page"];
    [request addPostValue:[NetWorkUtility StringEncode:tag] forKey:@"tag"];
    [request addPostValue:sign forKey:@"sign"];
...
{
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%@yx/api/room/listbyuid", kServerHost]];
...
{
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%@yx/api/ad/list", kServerHost]];
    NSString  *keyValueString = [NSString stringWithFormat:@"appkey=%@&page=%d&rows=%d",APPKEY,page,rows];
    NSString  *sign = [NSString stringWithFormat:@"%@",[NetWorkUtility generateSign:keyValueString]];
    __block ASIFormDataRequest *request = [ASIFormDataRequest requestWithURL:url];
    [request addPostValue:APPKEY forKey:@"appkey"];
    ...
    [request setCompletionBlock:^{
        ...
        NSString *msg = @"";
        if (flag) {
            adsArray = (NSArray *)[dic objectForKey:@"ads"];
        }
        else
        {
            msg = [dic valueForKey:@"msg"];
...
#pragma mark - 获取常用路线
+(void)networkGetUserfavlineListWithUid:(double)uid page:(int)page rows:(int)rows success:(void (^)(BOOL, BOOL , NSArray *, NSString *))success failure:(void (^)(NSError *))failure
{
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%@yx/api/userfavline/list", kServerHost]];
    NSString  *keyValueString = [NSString stringWithFormat:@"appkey=%@&page=%d&rows=%d&uid=%lf",APPKEY,page,rows,uid];
    NSString  *sign = [NSString stringWithFormat:@"%@",[NetWorkUtility generateSign:keyValueString]];
    __block ASIFormDataRequest *request = [ASIFormDataRequest requestWithURL:url usingCache:[ASIDownloadCache sharedCache] andCachePolicy:ASIFallbackToCacheIfLoadFailsCachePolicy|ASIAskServerIfModifiedWhenStaleCachePolicy|ASIAskServerIfModifiedCachePolicy];
    [request addPostValue:APPKEY forKey:@"appkey"];
    [request addPostValue:[NSNumber numberWithInt:page] forKey:@"page"];
    [request addPostValue:[NSNumber numberWithInt:rows] forKey:@"rows"];
    [request addPostValue:[NSNumber numberWithDouble:uid] forKey:@"uid"];
    [request addPostValue:sign forKey:@"sign"];
    [request setRequestMethod:@"POST"];
    [request setCompletionBlock:^{
        NSString *responseString = [request responseString];
        ...
        if (flag) {
            hasnexpage = [[dic valueForKey:@"hasnextpage"]boolValue];
            adsArray = (NSArray *)[dic objectForKey:@"userfavlines"];
        }
        else
        {
            msg = [dic valueForKey:@"msg"];
...
+(void)networkAddUserfavlineWithUid:(double)uid lineID:(int)lineid success:(void (^)(BOOL, NSString *))success failure:(void (^)(NSError *))failure
{
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%@yx/api/userfavline/add", kServerHost]];
    NSString  *keyValueString = [NSString stringWithFormat:@"appkey=%@&lineid=%d&uid=%lf",APPKEY,lineid,uid];
    NSString  *sign = [NSString stringWithFormat:@"%@",[NetWorkUtility generateSign:keyValueString]];
    __block ASIFormDataRequest *request = [ASIFormDataRequest requestWithURL:url];
    [request addPostValue:APPKEY forKey:@"appkey"];
