...
#pragma mark - 获取常用路线
+(void)networkGetUserfavlineListWithUid:(double)uid page:(int)page rows:(int)rows success:(void (^)(BOOL flag, BOOL hasnextpage, NSArray *favArray, NSString * msg))success failure:(void (^)(NSError * error))failure;

+(void)networkAddUserfavlineWithUid:(double)uid lineID:(int)lineid success:(void (^)(BOOL flag, NSString * msg))success failure:(void (^)(NSError * error))failure;
@end
